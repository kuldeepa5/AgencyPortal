...
namespace AgencyPortaXaf.Blazor.Server {
    public partial class AgencyPortaXafBlazorApplication : BlazorApplication {
        public AgencyPortaXafBlazorApplication() {
            InitializeComponent();
        ...
        private void AgencyPortaXafBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
